...
const formGroups = [
    { id: "nomPromotion", label: "Nom de la promotion", type: "text", value: "DWWM3" },
    { id: "dateDebut", label: "Date de début", type: "date", value: "2024-01-01" },
    { id: "dateFin", label: "Date de fin", type: "date", value: "2024-12-01" },
    { id: "placesDisponibles", label: "Place(s) disponible(s)", type: "number", value: "15" },
];
