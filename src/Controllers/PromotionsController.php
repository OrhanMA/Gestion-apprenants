...
class PromotionsController
{
  ...
  // methode create, upddate, delete, show, index
  ...
  public function create($data)
  {
    ...
    $createResponse = $this->promotionRepository->create($data);
    http_response_code(201);
    header('Content-Type: application/json');
    $jsonData = json_encode(['created' => $createResponse, 'message' => 'La ressource a bien été créée', 'promotion' => $data]);
    echo $jsonData;
    exit();
  }
}
